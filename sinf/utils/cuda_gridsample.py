...
gridsample_grad2 = load(name='gridsample_grad2', sources=[osp.join(osp.expandvars('$NFS'), 'code/sinf/sinf/utils/gridsample_cuda.cpp'), osp.join(osp.expandvars('$NFS'), 'code/sinf/sinf/utils/gridsample_cuda.cu')], verbose=True)
